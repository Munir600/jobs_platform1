...
class _JobDetailScreenState extends State<JobDetailScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    if (widget.isEmployer) ...[
                      _buildEmployerStats(job),
                      const SizedBox(height: 16),
                      _buildStatusBadges(job),
                      const SizedBox(height: 16),
                      const Divider(),
                      const SizedBox(height: 16),
                    ],
  ...
  Widget _buildSliverAppBar(JobDetail job) {
    return SliverAppBar(
      expandedHeight: 150,
      pinned: true,
      backgroundColor: AppColors.primaryColor,
      flexibleSpace: FlexibleSpaceBar(
        background: Container(
          ...
          child: Center(
            child: Icon(Icons.work_outline, size: 80, color: Colors.white.withOpacity(0.3)),
          ),
        ),
      ),
      leading: IconButton(
  ...
  void _toggleJobStatus(JobDetail job, bool isActive) {
    ...
    final jobCreate = JobCreate(
      ...
      // isActive: isActive // Backend support pending for direct active toggle?
    );
